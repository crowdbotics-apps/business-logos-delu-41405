"""
Django settings for business_logos_delu_41405 project.
...
ROOT_URLCONF = 'business_logos_delu_41405.urls'
...
WSGI_APPLICATION = 'business_logos_delu_41405.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "business_logos_delu_41405 API",
    "DESCRIPTION": "API documentation for business_logos_delu_41405 App",
    "VERSION": "v1",
}
